        ...
        <template v-for="(item, i) in mainMenuList" :key="i">
          <template v-if="item.accessible">
            ...
            <template v-for="(menuItem, j) in item.pages" :key="j">
              <template v-if="menuItem.heading && menuItem.accessible">
                <div class="menu-item">
                  <router-link
                    v-if="menuItem.route"
                    class="menu-link"
              ...
              <div
                v-if="
                  menuItem.sectionTitle && menuItem.route && menuItem.accessible
                "
              ...
              >
                ...
                >
                  <template v-for="(item2, k) in menuItem.sub" :key="k">
                    ...
                    <div
                      v-if="
                        item2.sectionTitle && item2.route && menuItem.accessible
                      "
                      ...
                      >
                        <template v-for="(item3, k) in item2.sub" :key="k">
                          <div v-if="item3.heading" class="menu-item">
                            <router-link
                              v-if="item3.route && menuItem.accessible"
                              class="menu-link"
                              active-class="active"
                              :to="item3.route"
                            >
...
export default defineComponent({
  ...
  setup() {
    ...
    const mainMenuList = computed(() => {
      ...
      return MainMenuConfig.getMainMenu(role);
    });
